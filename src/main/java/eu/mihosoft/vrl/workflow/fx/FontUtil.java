...
public final class FontUtil {
   ...
   * @param wrappingWidth wrapping width ( string width is defined as
   *        {@code min(text.prefWidth, text.wrappingWidth)} )
   ...
   */
  public static double computeStringHeight(Font font, String text, double wrappingWidth,
   ...
   * @return the height of the specified text
   */
  static double computeStringHeight(Font font, String text, double wrappingWidth,
      double lineSpacing, TextBoundsType boundsType) {
    // see com.sun.javafx.scene.control.skin.Utils
    helper.setText(text);
    helper.setFont(font);
