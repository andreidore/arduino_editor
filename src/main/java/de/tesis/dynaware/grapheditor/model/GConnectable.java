 ...
 * <ul>
 * <li>{@link de.tesis.dynaware.grapheditor.model.GConnectable#getConnectors
 * <em>Connectors</em>}</li>
 * </ul>
 * </p>
 *
 ...
 * @generated
 */
public interface GConnectable {
	/**
	 * Returns the value of the '<em><b>Connectors</b></em>' containment reference
	 * list. The list contents are of type
	 * {@link de.tesis.dynaware.grapheditor.model.GConnector}. It is bidirectional
	 * and its opposite is
	 * '{@link de.tesis.dynaware.grapheditor.model.GConnector#getParent
	 * <em>Parent</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Connectors</em>' containment reference list isn't
	 ...
	 * @generated
	 */
	ObservableList<GConnector> getConnectors();
