...
public class GConnectorImpl implements GConnector {
	...
	public GConnectable getParent() {
		if (eContainerFeatureID() != GraphPackage.GCONNECTOR__PARENT)
			return null;
	...
	public void setParent(GConnectable newParent) {
		if (newParent != eInternalContainer()
			...
			if (newParent != null)
				msgs = ((InternalEObject) newParent).eInverseAdd(this, GraphPackage.GCONNECTABLE__CONNECTORS,
						GConnectable.class, msgs);
			msgs = basicSetParent(newParent, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GCONNECTOR__PARENT, newParent,
					newParent));
	}
	...
	public EList<GConnection> getConnections() {
		if (connections == null) {
			connections = new EObjectResolvingEList<GConnection>(GConnection.class, this,
					GraphPackage.GCONNECTOR__CONNECTIONS);
		}
		return connections;
	}
	...
	public void setConnectionDetachedOnDrag(boolean newConnectionDetachedOnDrag) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GCONNECTOR__CONNECTION_DETACHED_ON_DRAG,
					oldConnectionDetachedOnDrag, connectionDetachedOnDrag));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case GraphPackage.GCONNECTOR__PARENT:
			return eInternalContainer().eInverseRemove(this, GraphPackage.GCONNECTABLE__CONNECTORS, GConnectable.class,
					msgs);
		}
