...
public interface SelectionManager {
	...
	/**
	 * Cuts the current selection. Saves cut nodes and the connections between them
	 * to memory to be pasted later.
	 */
	void cut();
	 ...
	 *
	 * <p>
	 * Additionally calls the given method for the compound command that removed the
	 * nodes.
	 * </p>
	 *
	 * @param consumer a consumer to append additional commands to this one
	 */
	void cut(Consumer<List<GNode>> consumer);

	/**
	 * Copies the current selection. Saves copied nodes and the connections between
	 * them to memory to be pasted later.
	 */
	void copy();
	 ...
	 *
	 * <p>
	 * Additionally calls the given method for the compound command that pasted the
	 * nodes.
	 * </p>
	 *
	 * @param consumer a consumer to append additional commands to this one
	 */
	void paste(Consumer<List<GNode>> consumer);

	/**
	 * Clears the memory of what was cut / copied, so that future paste calls will
	 * do nothing.
	 */
	void clearMemory();

	/**
	 * Selects all selectable elements (nodes, joints, and connections) in the graph
	 * editor.
	 */
	void selectAll();
	 ...
	 *
	 * <p>
	 * Additionally calls the given method for the compound command that did the
	 * deletion.
	 * </p>
	 *
	 * @param consumer a consumer to append additional commands to this one
	 */
	void deleteSelection(Consumer<List<GNode>> consumer);

	/**
	 * Sets an optional predicate to be called when the selection-box changes to see
	 * if connections should be selected.
	 *
	 * <p>
	 * The predicate should return true if the connection is inside the selection
	 * box. Setting a null predicate means no connections will be selected by the
	 * selection-box. This is the default behaviour.
	 * </p>
	 *
	 * @param connectionPredicate a predicate that checks if a connection is inside
	 *                            the selection-box
	 */
