...
public class GraphEditorMinimap extends PanningWindowMinimap {
	...
	// Until the content is set, we don't know the aspect ratio of the minimap. Use
	 ...
	 *
	 * @param width
	 *            the width to be set for this minimap
	 */
	...
	/**
	 * Binds the aspect ratio of the minimap to the aspect ratio of the content that
	 * the minimap is representing.
	 */
	...
	/**
	 * Creates a change listener that will listen to changes in the model and redraw
