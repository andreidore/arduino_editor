 ...
 * the usual way. For large graphs, the editor can be put inside a
 * {@link GraphEditorContainer} instead.
 * </p>
 *
 * <p>
...
public interface GraphEditor {
	 ...
	 *
	 * <p>
	 * All {@link GNode} model elements that have a '<em><b>Type</b></em>' attribute
	 * equal to type set here will be rendered using this skin.
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * All {@link GConnector} model elements that have a '<em><b>Type</b></em>'
	 * attribute equal to type set here will be rendered using this skin.
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * All {@link GConnection} model elements that have a '<em><b>Type</b></em>'
	 * attribute equal to type set here will be rendered using this skin.
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * All {@link GJoint} model elements that have a '<em><b>Type</b></em>'
	 * attribute equal to type set here will be rendered using this skin.
	 * </p>
	 *
	 ...
	 * <p>
	 * All {@link GConnector} model elements that have a '<em><b>Type</b></em>'
	 * attribute equal to type set here will have their tails rendered using this
	 * skin.
	 * </p>
	 *
	 * @param type the {@link GConnector} type for which this skin should be used
	 ...
	 *
	 * <p>
	 * This will be used to decide which connections are allowed / forbidden during
	 * drag & drop events in the editor.
	 * </p>
	 *
	 * @param validator a custom validator implements {@link GConnectorValidator},
	 *                  or null to use the default validator
	 */
	 ...
	 * <p>
	 * <b>Note: </b><br>
	 * If the model is updated via EMF commands, as is recommended, it should rarely
	 * be necessary to call this method. The model will be reloaded automatically
	 * via a command-stack listener.
	 * </p>
	 */
	void reload();
	 ...
	 *
	 * <p>
	 * The view is a JavaFX {@link Region}. It should be added to the scene graph in
	 * the usual way.
	 * </p>
	 *
	 ...
	 * </p>
	 *
	 * @return an {@link GraphEditorProperties} instance containing the properties
	 *         of the editor
	 */
	 ...
	 *
	 * @param properties an {@link GraphEditorProperties} instance specifying a set
	 *                   of properties for the editor
	 */
	 ...
	 *
	 * <p>
	 * The skin lookup is used to get any skin instance associated to a model
	 * element instance.
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * This provides access to actions like 'select all', 'delete selection', cut,
	 ...
	 *
	 * <p>
	 * This can be used to append additional commands to the one that created the
	 * connection.
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * This can be used to append additional commands to the one that removed the
	 * connection.
	 * </p>
	 *
	 * @param consumer a consumer to append additional commands
	 */
	void setOnConnectionRemoved(Consumer<GConnection> consumer);
}
