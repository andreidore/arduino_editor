 ...
 * dragged
 * <li>SelectionDeleter - deletes selected nodes and dependent connectors,
 * connections, etc
 * <li>SelectionBackup - used to backup the current selection and restore it
 * later
 * <li>SelectionTracker - keeps track of the current selection
 * <li>SelectionCopier - copies and stores the current selection to be pasted
 * later
 * </ol>
 *
 * </p>
...
public class DefaultSelectionManager implements SelectionManager {
	...
	@Override
	public void cut(Consumer<List<GNode>> consumer) {
	...
	@Override
	public void paste(final Consumer<List<GNode>> consumer) {
