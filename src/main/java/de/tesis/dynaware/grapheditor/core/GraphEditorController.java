 ...
 * for the current {@link GModel}, and adding them to the
...
public class GraphEditorController {
	...
	public GraphEditorController(final SkinManager skinManager, final ConnectionEventManager connectionEventManager) {
		...
		modelEditingManager = new ModelEditingManager();
	...
	/**
	 * Gets the {@link GraphEditorView} instance. Returned as a {@link Region} so
	 * that it's read-only.
	 *
	...
	public void setModel(final GModel model) {
		...
		// Perform single null check here. All secondary managers can assume that the
		// model is not null.
		if (model != null) {
			initializeAll();
		}
	 ...
	 *            a {@link GraphEditorProperties} instance to be used
	 */
	 ...
	 * 
	 * @param validator
	 *            a {@link GConnectorValidator} implementaiton, or null to use the
	 *            default
	 */
	 ...
	 *
	 * <p>
	 * Uses the skin manager to create skins for the current model, and adds the
	 * skin instances to the view.
	 * </p>
	 */
	...
	/**
	 * Cleans up the view, removing all elements that the {@link ModelMemory} tells
	 * us to remove.
	 */
	...
	/**
	 * Updates the skin manager, adding and removing skin instances according to
	 * what the {@link ModelMemory} specifies.
	 */
