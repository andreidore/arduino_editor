...
public class DefaultSkinController implements SkinController {
	 ...
	 *
	 * @param position
	 *            the position of the new connector
	 * @param input
	 *            {@code true} for input, {@code false} for output
	 */
	@Override
	...
	/**
	 * Counts the number of connectors the given node currently has of the given
	 * type.
	 *
	 * @param node
	 *            a {@link GNode} instance
	 * @param side
	 *            the {@link Side} the connector is on
	...
	/**
	 * Gets the connector type string corresponding to the given position and input
	 * values.
	 * 
	 * @param position
	 *            a {@link Side} value
